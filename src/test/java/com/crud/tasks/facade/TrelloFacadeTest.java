...
public class TrelloFacadeTest {
    ...
    @Mock
    private TrelloMapper trelloMapperr;
    ...
    void shouldFetchTrelloBoards() {
        ...
        when(trelloMapperr.mapToBoards(trelloBoards)).thenReturn(mappedTrelloBoards);
        when(trelloMapperr.mapToBoardsDto(anyList())).thenReturn(trelloBoards);
